...
This is curated research from 2024-2026, organized around a single argument: AI is accelerating code output, the delivery system is not keeping pace, and the downstream strain on teams is real and measurable.

Methodology note: vendor surveys, controlled studies, and third-party research use different methods and have different reliability profiles. Where relevant, that context is noted.
...
What this means: the output half of the value stream has genuinely accelerated. The absorption half has not.
...
Methodology note: McKinsey consulting research, not a controlled study. But the range is consistent with GitHub's numbers and broadly accepted.
...
Methodology note: vendor survey with potential self-selection bias. Treat the number as directional.
...
This is the most directly relevant data set. Some key numbers for teams with heavy AI coding tool adoption:
...
Source: Harness / Coleman Parkes State of DevOps Modernization 2026 report
Methodology note: vendor-sponsored survey. The direction of these findings is consistent with DORA and other independent research, but self-reported numbers should be read as indicators, not precise measurements.
...
What this means: AI amplifies the existing system. If the system is weak, AI makes it weaker.
...
Methodology note: this is a controlled study, which makes it more reliable than survey data. The result does not mean AI is useless; it means the gains are not uniform and context matters.
...
**Harness / Coleman Parkes 2026 (continued)**
...
What that last number means: teams are confident about their capabilities even when the outcomes data shows otherwise. Confidence and performance are not the same thing.
...
Source: McKinsey
What this means: organizations that invest only in AI tools and not in the surrounding system will not realize the gains they are expecting.
